  ...
  [
    {
      ...
      "environment": [{
        ...
        "value": "https://\${data.aws_ssm_parameter.datasource_muenster_username.value}:\${data.aws_ssm_parameter.datasource_muenster_password.value}@\${data.aws_ssm_parameter.datasource_muenster_connection_uri.value}"
      },
      {
